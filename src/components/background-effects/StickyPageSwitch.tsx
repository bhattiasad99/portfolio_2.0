...
const Section1 = ({ scrollYProgress }: StickySectionProps) => {
...
const Section2 = ({ scrollYProgress }: StickySectionProps) => {
        ...
        >
            ...
            <article className='container mx-auto relative z-10 '>
                ...
                <div className='grid grid-cols-4 gap-4'>
                    {sectionImages.map(({ src, alt, className, sizes }) => (
